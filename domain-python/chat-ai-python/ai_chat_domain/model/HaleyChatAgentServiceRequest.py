...
class HaleyChatAgentServiceRequest(HaleyChatAgentServiceCommand):
    ...
    def get_allowed_properties(cls):
        return super().get_allowed_properties() + HaleyChatAgentServiceRequest._allowed_properties

    @classmethod
    def get_class_uri(cls) -> str:
        return 'http://vital.ai/ontology/chat-ai#HaleyChatAgentServiceRequest'
