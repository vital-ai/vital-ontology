...
class HaleyChatAgentServiceResponse(HaleyChatAgentServiceCommand):
    _allowed_properties = [
        {'uri': 'http://vital.ai/ontology/chat-ai#hasHaleyInterAccountRequestURI', 'prop_class': URIProperty}, 
    ]
