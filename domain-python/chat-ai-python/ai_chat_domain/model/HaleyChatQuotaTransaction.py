...
class HaleyChatQuotaTransaction(VITAL_Node):
    _allowed_properties = [
        ...
        {'uri': 'http://vital.ai/ontology/chat-ai#hasHaleyChatQuotaTransactionTypeURI', 'prop_class': URIProperty}, 
        ...
        {'uri': 'http://vital.ai/ontology/chat-ai#hasInputTokenCount', 'prop_class': IntegerProperty}, 
        {'uri': 'http://vital.ai/ontology/chat-ai#hasOutputTokenCount', 'prop_class': IntegerProperty}, 
    ...
    def get_allowed_properties(cls):
        return super().get_allowed_properties() + HaleyChatQuotaTransaction._allowed_properties

    @classmethod
    def get_class_uri(cls) -> str:
        return 'http://vital.ai/ontology/chat-ai#HaleyChatQuotaTransaction'
