...
class AccountInteractionTransaction(BaseInteractionTransaction):
    _allowed_properties = [
        {'uri': 'http://vital.ai/ontology/vital-aimp#hasAccountInteractionFee', 'prop_class': FloatProperty}, 
        {'uri': 'http://vital.ai/ontology/vital-aimp#hasAccountInteractionTotalFee', 'prop_class': FloatProperty}, 
    ]
