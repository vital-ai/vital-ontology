...
class AgentDatascriptCallResponse(VITAL_Node):
    _allowed_properties = [
        ...
        {'uri': 'http://vital.ai/ontology/vital-aimp#hasBindingNames', 'prop_class': StringProperty}, 
        {'uri': 'http://vital.ai/ontology/vital-aimp#hasDatascriptScope', 'prop_class': StringProperty}, 
        ...
        {'uri': 'http://vital.ai/ontology/vital-aimp#hasTotalResults', 'prop_class': IntegerProperty}, 
    ]

    @classmethod
    def get_allowed_properties(cls):
        return super().get_allowed_properties() + AgentDatascriptCallResponse._allowed_properties

    @classmethod
    def get_class_uri(cls) -> str:
        return 'http://vital.ai/ontology/vital-aimp#AgentDatascriptCallResponse'
