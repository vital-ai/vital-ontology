...
class AnswerStatusMessage(AIMPMessage):
    _allowed_properties = [
        ...
        {'uri': 'http://vital.ai/ontology/vital-aimp#isUpdateAnswer', 'prop_class': BooleanProperty}, 
    ]

    @classmethod
    def get_allowed_properties(cls):
        return super().get_allowed_properties() + AnswerStatusMessage._allowed_properties

    @classmethod
    def get_class_uri(cls) -> str:
        return 'http://vital.ai/ontology/vital-aimp#AnswerStatusMessage'
