...
class DialogCallDialog(DialogAction):
    _allowed_properties = [
    ...
    def get_allowed_properties(cls):
        return super().get_allowed_properties() + DialogCallDialog._allowed_properties

    @classmethod
    def get_class_uri(cls) -> str:
        return 'http://vital.ai/ontology/vital-aimp#DialogCallDialog'
