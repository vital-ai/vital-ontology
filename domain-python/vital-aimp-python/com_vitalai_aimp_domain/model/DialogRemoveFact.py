...
class DialogRemoveFact(DialogAction):
    _allowed_properties = [
        ...
        {'uri': 'http://vital.ai/ontology/vital-aimp#isRemoveWholeProfile', 'prop_class': BooleanProperty}, 
    ]

    @classmethod
    def get_allowed_properties(cls):
        return super().get_allowed_properties() + DialogRemoveFact._allowed_properties
