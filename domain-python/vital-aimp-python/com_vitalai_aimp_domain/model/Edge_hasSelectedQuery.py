...
class Edge_hasSelectedQuery(VITAL_TaxonomyEdge):
    _allowed_properties = [
        {'uri': 'http://vital.ai/ontology/vital-aimp#hasSelectedQueryName', 'prop_class': StringProperty}, 
        {'uri': 'http://vital.ai/ontology/vital-aimp#isGlobalQuery', 'prop_class': BooleanProperty}, 
    ]
