...
class FacebookPost(Document):
    _allowed_properties = [
        {'uri': 'http://vital.ai/ontology/vital-aimp#hasCommentsCount', 'prop_class': LongProperty}, 
        {'uri': 'http://vital.ai/ontology/vital-aimp#hasLikesCount', 'prop_class': LongProperty}, 
    ...
    def get_allowed_properties(cls):
        return super().get_allowed_properties() + FacebookPost._allowed_properties
