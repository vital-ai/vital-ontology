...
class GridItemResult(VITAL_Node):
    _allowed_properties = [
    ...
    def get_allowed_properties(cls):
        return super().get_allowed_properties() + GridItemResult._allowed_properties

    @classmethod
    def get_class_uri(cls) -> str:
        return 'http://vital.ai/ontology/vital-aimp#GridItemResult'
