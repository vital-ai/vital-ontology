...
class IosDeviceProfile(EndpointProfile):
    _allowed_properties = [
        ...
        {'uri': 'http://vital.ai/ontology/vital-aimp#hasUuid', 'prop_class': StringProperty}, 
        {'uri': 'http://vital.ai/ontology/vital-aimp#isNotificationsEnabled', 'prop_class': BooleanProperty}, 
    ]
