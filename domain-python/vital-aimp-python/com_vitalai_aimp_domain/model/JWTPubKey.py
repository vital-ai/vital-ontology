...
class JWTPubKey(VITAL_Node):
    _allowed_properties = [
        ...
        {'uri': 'http://vital.ai/ontology/vital-aimp#hasJwtPubKeyString', 'prop_class': StringProperty}, 
    ]

    @classmethod
    def get_allowed_properties(cls):
        return super().get_allowed_properties() + JWTPubKey._allowed_properties

    @classmethod
    def get_class_uri(cls) -> str:
        return 'http://vital.ai/ontology/vital-aimp#JWTPubKey'
