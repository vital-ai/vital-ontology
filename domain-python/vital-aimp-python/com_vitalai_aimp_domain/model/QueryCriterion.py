...
class QueryCriterion(DialogPart):
    _allowed_properties = [
        ...
        {'uri': 'http://vital.ai/ontology/vital-aimp#hasCriterionType', 'prop_class': StringProperty}, 
    ...
    def get_allowed_properties(cls):
        return super().get_allowed_properties() + QueryCriterion._allowed_properties

    @classmethod
    def get_class_uri(cls) -> str:
        return 'http://vital.ai/ontology/vital-aimp#QueryCriterion'
