...
class SearchResult(VITAL_Node):
    ...
    def get_allowed_properties(cls):
        return super().get_allowed_properties() + SearchResult._allowed_properties

    @classmethod
    def get_class_uri(cls) -> str:
        return 'http://vital.ai/ontology/vital-aimp#SearchResult'
