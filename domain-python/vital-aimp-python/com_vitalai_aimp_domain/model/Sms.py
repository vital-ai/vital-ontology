...
class Sms(VITAL_Node):
    _allowed_properties = [
        ...
        {'uri': 'http://vital.ai/ontology/vital-aimp#hasDateSent', 'prop_class': DateTimeProperty}, 
    ...
    def get_allowed_properties(cls):
        return super().get_allowed_properties() + Sms._allowed_properties

    @classmethod
    def get_class_uri(cls) -> str:
        return 'http://vital.ai/ontology/vital-aimp#Sms'
