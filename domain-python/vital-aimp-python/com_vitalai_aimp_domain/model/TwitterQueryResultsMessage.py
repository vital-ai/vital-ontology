...
class TwitterQueryResultsMessage(TwitterMessage):
    _allowed_properties = [
        ...
        {'uri': 'http://vital.ai/ontology/vital-aimp#hasRadius', 'prop_class': StringProperty}, 
        ...
        {'uri': 'http://vital.ai/ontology/vital-aimp#hasTweetIDs', 'prop_class': LongProperty}, 
        {'uri': 'http://vital.ai/ontology/vital-aimp#isCountOnly', 'prop_class': BooleanProperty}, 
    ]

    @classmethod
    def get_allowed_properties(cls):
        return super().get_allowed_properties() + TwitterQueryResultsMessage._allowed_properties

    @classmethod
    def get_class_uri(cls) -> str:
        return 'http://vital.ai/ontology/vital-aimp#TwitterQueryResultsMessage'
