...
class Edge_hasSentenceAbbreviationInstance(VITAL_TaxonomyEdge):
    _allowed_properties = [
    ]

    @classmethod
    def get_allowed_properties(cls):
        return super().get_allowed_properties() + Edge_hasSentenceAbbreviationInstance._allowed_properties
