...
class Image(VITAL_Node):
    _allowed_properties = [
        {'uri': 'http://vital.ai/ontology/vital-nlp#hasContentType', 'prop_class': StringProperty}, 
        ...
        {'uri': 'http://vital.ai/ontology/vital-nlp#hasImageData', 'prop_class': StringProperty}, 
        {'uri': 'http://vital.ai/ontology/vital-nlp#hasWidthPx', 'prop_class': IntegerProperty}, 
    ]

    @classmethod
    def get_allowed_properties(cls):
        return super().get_allowed_properties() + Image._allowed_properties

    @classmethod
    def get_class_uri(cls) -> str:
        return 'http://vital.ai/ontology/vital-nlp#Image'
