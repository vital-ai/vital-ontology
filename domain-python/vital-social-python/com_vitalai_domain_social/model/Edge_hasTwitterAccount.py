...
class Edge_hasTwitterAccount(VITAL_TaxonomyEdge):
    _allowed_properties = [
        ...
        {'uri': 'http://vital.ai/ontology/vital-social#isStreamContextUser', 'prop_class': BooleanProperty}, 
    ]

    @classmethod
    def get_allowed_properties(cls):
        return super().get_allowed_properties() + Edge_hasTwitterAccount._allowed_properties
