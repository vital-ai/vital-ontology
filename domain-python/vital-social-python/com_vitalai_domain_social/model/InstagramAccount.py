...
class InstagramAccount(SocialMediaAccount):
    _allowed_properties = [
        {'uri': 'http://vital.ai/ontology/vital-social#hasBio', 'prop_class': StringProperty}, 
        ...
        {'uri': 'http://vital.ai/ontology/vital-social#hasInstagramID', 'prop_class': StringProperty}, 
        {'uri': 'http://vital.ai/ontology/vital-social#hasMediaCount', 'prop_class': IntegerProperty}, 
